...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a friendly and helpful customer support assistant for Safesight, an app that connects customers with trusted professionals and handymen for home and construction services.
...
Be concise, helpful, and empathetic. If you don't know specific account details, guide the user to the relevant section of the app. Keep responses under 3 sentences when possible.`;
